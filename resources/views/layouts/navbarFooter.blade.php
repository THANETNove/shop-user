    ...
    <div class="container">
        <div class="row row-cols-auto">
          ...
          <div class="col-2 col-sm-2 col-md-3">
              <i class="fa-solid fa-location-dot navbarFooter"  id="#"  value="location" style='font-size:28px'>
                <br>
          ...
          <div class="col-2 col-sm-2  col-md-2"> 
              <i class="fa-solid fa-gift navbarFooter" id="gift"  value="" style='font-size:28px'>
                <br>
